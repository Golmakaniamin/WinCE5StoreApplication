================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Prn_Borna Project Overview
===============================================================================

The application wizard has created this Prn_Borna application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Prn_Borna application.
...
Prn_Borna.h
    ...
    project specific headers and declares the CPrn_BornaApp application class.
...
Prn_BornaDlg.h, Prn_BornaDlg.cpp - the dialog
    These files contain your CPrn_BornaDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Prn_Borna.pch and a precompiled types file named StdAfx.obj.
